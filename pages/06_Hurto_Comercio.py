...
def cargar_datos():
    ...
    while True:
        url = (
            f"https://www.datos.gov.co/resource/7i2x-h5vp.csv?"
...
st.set_page_config(page_title="Hurto a Comercio", layout="wide")
...
if "com_periodo" not in st.session_state:
    st.session_state["com_periodo"] = "Año Gobierno"
eje_x = st.selectbox(
    "Selecciona periodo:",
...
presidente_mapa = st.selectbox(
    ...
    key="com_map_presidente",
)

if "com_map_periodo" not in st.session_state:
    st.session_state["com_map_periodo"] = "Año Gobierno"
