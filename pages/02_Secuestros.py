...
tipo_delito = st.selectbox("Selecciona tipo delito:", ["TODOS"] + tipos)
...
fig1 = px.line(
    ...
    color="Presidente",
    markers=True,
    title=f"Comparativo presidencial - {metrica_sec}",
)
...
fig2 = px.line(
    ...
    color="Presidente",
    markers=True,
    title=f"Acumulado presidencial - {metrica_sec}",
)
